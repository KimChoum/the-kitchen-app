//
//  ViewIngredientViewNoDelete.swift
//  The Kitchen App
//
...
struct ViewIngredientViewNoDelete: View {
...
struct ViewIngredientViewNoDelete_Previews: PreviewProvider {
    @State static var ingredient: Ingredient = Ingredient()
    static var previews: some View {
        ViewIngredientViewNoDelete(ingredient: $ingredient)
    }
}
